...
const meta = {
  en: {
    ...
    'humanitart-volontararbete': {
      ...
      stats: [{ value: '18–35', label: 'Age requirement' }, { value: '5 days', label: 'Mandatory in-person training' }, { value: 'Outside EU', label: 'Placements in third countries' }],
      source: 'Source: youth.europa.eu, commission.europa.eu and eacea.ec.europa.eu',
    },
    'erasmus-plus': {
    ...
    'eures': {
      ...
      stats: [{ value: '~4m', label: 'Job vacancies in database' }, { value: '1,000+', label: 'EURES advisers' }, { value: '31', label: 'Countries covered' }],
    ...
    'eures-targeted-mobility': {
      ...
      stats: [{ value: '18+', label: 'Age — no other requirements' }, { value: '3', label: 'Active lead projects' }, { value: 'EaSI', label: 'ESF+ funding' }],
      source: 'Source: eures.europa.eu (official EURES portal)',
    },
    'eurodesk': {
      ageRange: '13–30 years', duration: 'Ongoing service', funding: 'Free',
      stats: [{ value: '38', label: 'Eurodesk centres in Europe' }, { value: '3,500+', label: 'Local multipliers' }, { value: '200+', label: 'Programmes in Opportunity Finder' }],
    ...
    'eu-youth-portal': {
      ...
      stats: [{ value: '24', label: 'Official EU languages' }, { value: '4', label: 'Main sections' }, { value: 'Free', label: 'Always available' }],
  ...
  es: {
    ...
    'humanitart-volontararbete': {
      ...
      stats: [{ value: '18–35', label: 'Requisito de edad' }, { value: '5 días', label: 'Formación presencial obligatoria' }, { value: 'Fuera de la UE', label: 'Destinos en terceros países' }],
      source: 'Fuente: youth.europa.eu, commission.europa.eu y eacea.ec.europa.eu',
    },
    'erasmus-plus': {
    ...
    'eures': {
      ...
      stats: [{ value: '~4 mill.', label: 'Ofertas en la base de datos' }, { value: '1.000+', label: 'Asesores EURES' }, { value: '31', label: 'Países cubiertos' }],
    ...
    'eures-targeted-mobility': {
      ...
      stats: [{ value: '18+', label: 'Edad — sin otros requisitos' }, { value: '3', label: 'Proyectos líderes activos' }, { value: 'EaSI', label: 'Financiación ESF+' }],
      source: 'Fuente: eures.europa.eu (portal oficial de EURES)',
    },
    'eurodesk': {
      ageRange: '13–30 años', duration: 'Servicio continuo', funding: 'Gratuito',
      stats: [{ value: '38', label: 'Centros Eurodesk en Europa' }, { value: '3.500+', label: 'Multiplicadores locales' }, { value: '200+', label: 'Programas en Opportunity Finder' }],
    ...
    'eu-youth-portal': {
      ...
      stats: [{ value: '24', label: 'Idiomas oficiales de la UE' }, { value: '4', label: 'Secciones principales' }, { value: 'Gratis', label: 'Siempre disponible' }],
  ...
  it: {
    ...
    'humanitart-volontararbete': {
      ...
      stats: [{ value: '18–35', label: 'Requisito di età' }, { value: '5 giorni', label: 'Formazione in presenza obbligatoria' }, { value: 'Extra-UE', label: 'Incarichi in paesi terzi' }],
      source: "Fonte: youth.europa.eu, commission.europa.eu ed eacea.ec.europa.eu",
    },
    'erasmus-plus': {
    ...
    'eures': {
      ...
      stats: [{ value: '~4 mln', label: 'Offerte nel database' }, { value: '1.000+', label: 'Consulenti EURES' }, { value: '31', label: 'Paesi coperti' }],
    ...
    'eures-targeted-mobility': {
      ...
      stats: [{ value: '18+', label: 'Età — nessun altro requisito' }, { value: '3', label: 'Progetti guida attivi' }, { value: 'EaSI', label: 'Finanziamento ESF+' }],
      source: 'Fonte: eures.europa.eu (portale ufficiale EURES)',
    },
    'eurodesk': {
      ageRange: '13–30 anni', duration: 'Servizio continuo', funding: 'Gratuito',
      stats: [{ value: '38', label: 'Centri Eurodesk in Europa' }, { value: '3.500+', label: 'Moltiplicatori locali' }, { value: '200+', label: 'Programmi in Opportunity Finder' }],
    ...
    'eu-youth-portal': {
      ...
      stats: [{ value: '24', label: "Lingue ufficiali dell'UE" }, { value: '4', label: 'Sezioni principali' }, { value: 'Gratuito', label: 'Sempre disponibile' }],
  ...
  de: {
    ...
    'humanitart-volontararbete': {
      ...
      stats: [{ value: '18–35', label: 'Altersanforderung' }, { value: '5 Tage', label: 'Obligatorische Präsenzausbildung' }, { value: 'Außerhalb der EU', label: 'Einsätze in Drittländern' }],
      source: 'Quelle: youth.europa.eu, commission.europa.eu und eacea.ec.europa.eu',
    },
    'erasmus-plus': {
    ...
    'eures': {
      ...
      stats: [{ value: '~4 Mio.', label: 'Stellen in der Datenbank' }, { value: '1.000+', label: 'EURES-Berater' }, { value: '31', label: 'Länder abgedeckt' }],
    ...
    'eures-targeted-mobility': {
      ...
      stats: [{ value: '18+', label: 'Alter — keine weiteren Anforderungen' }, { value: '3', label: 'Aktive Leitprojekte' }, { value: 'EaSI', label: 'ESF+-Finanzierung' }],
      source: 'Quelle: eures.europa.eu (offizielles EURES-Portal)',
    },
    'eurodesk': {
      ageRange: '13–30 Jahre', duration: 'Laufender Dienst', funding: 'Kostenlos',
      stats: [{ value: '38', label: 'Eurodesk-Zentren in Europa' }, { value: '3.500+', label: 'Lokale Multiplikatoren' }, { value: '200+', label: 'Programme im Opportunity Finder' }],
    ...
    'eu-youth-portal': {
      ...
      stats: [{ value: '24', label: 'Offizielle EU-Sprachen' }, { value: '4', label: 'Hauptabschnitte' }, { value: 'Kostenlos', label: 'Immer verfügbar' }],
