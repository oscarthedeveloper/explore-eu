  ...
  es: {
    ...
    'erasmus-plus': {
      formats: [
        ...
        { icon: '🏛️', title: 'Apoyo a las políticas (KA3) y Jean Monnet', duration: 'Variable', description: 'La tercera Acción Clave (KA3) apoya el desarrollo de políticas y la cooperación. Las acciones Jean Monnet son una parte aparte — apoyo a la docencia e investigación sobre la integración europea.', bullets: ['KA3: apoyo a la reforma de políticas', 'Módulos y cátedras Jean Monnet', 'Centros de Excelencia', 'El deporte como parte propia'] },
      ],
      covered: [
    ...
    'eures': {
      formats: [
        { icon: '🔍', title: 'Portal EURES', duration: 'Siempre disponible', description: 'Plataforma en línea con casi 4 millones de ofertas y 1 millón de currículos. Emparejamiento de empleos y candidatos.', bullets: ['Busca empleo en 31 países', 'Sube tu currículum', 'Filtra por país, sector y educación', 'Gratuito para todos'] },
        { icon: '👤', title: 'Asesores EURES', duration: 'Cita previa', description: 'Asesoramiento personalizado de más de 1.000 asesores especializados en 270 organizaciones EURES.', bullets: ['Revisión y mejora del currículum', 'Asesoramiento jurídico sobre seguridad social', 'Información sobre condiciones de vida y trabajo', 'Contacto a través del portal, teléfono o chat'] },
      ],
      covered: [
        { icon: '🔍', title: 'Base de datos de empleo', desc: 'casi 4 millones de ofertas y 1 millón de currículos en el portal EURES.' },
      ...
      steps: [
        ...
        { n: '02', title: 'Busca empleo', desc: 'Navega entre casi 4 millones de ofertas. Filtra por ubicación, tipo y requisitos educativos.' },
  ...
  it: {
    ...
    'erasmus-plus': {
      formats: [
        ...
        { icon: '🏛️', title: 'Sostegno alle politiche (KA3) e Jean Monnet', duration: 'Variabile', description: "La terza Azione Chiave (KA3) sostiene lo sviluppo delle politiche e la cooperazione. Le azioni Jean Monnet sono una parte a sé — sostegno all'insegnamento e alla ricerca sull'integrazione europea.", bullets: ['Moduli e cattedre Jean Monnet', 'Centri di Eccellenza', 'KA3: sostegno alla riforma delle politiche', 'Lo sport come parte propria'] },
      ],
      covered: [
    ...
    'eures': {
      formats: [
        { icon: '🔍', title: 'Portale EURES', duration: 'Sempre disponibile', description: 'Piattaforma online con quasi 4 milioni di offerte e 1 milione di CV. Abbinamento di lavori e candidati.', bullets: ['Cerca lavoro in 31 paesi', 'Carica il tuo CV', 'Filtra per paese, settore e istruzione', 'Gratuito per tutti'] },
        { icon: '👤', title: 'Consulenti EURES', duration: 'Su appuntamento', description: 'Consulenza personale da oltre 1.000 consulenti specializzati in 270 organizzazioni EURES.', bullets: ['Revisione e miglioramento del CV', 'Consulenza legale sulla previdenza sociale', 'Informazioni sulle condizioni di vita e lavoro', 'Contatto tramite portale, telefono o chat'] },
      ],
      covered: [
        { icon: '🔍', title: 'Database offerte di lavoro', desc: 'quasi 4 milioni di offerte e 1 milione di CV sul portale EURES.' },
      ...
      steps: [
        ...
        { n: '02', title: 'Cerca lavoro', desc: 'Sfoglia quasi 4 milioni di offerte. Filtra per posizione, tipo e requisiti educativi.' },
  ...
  de: {
    ...
    'erasmus-plus': {
      formats: [
        ...
        { icon: '🏛️', title: 'Politikunterstützung (KA3) & Jean Monnet', duration: 'Variiert', description: 'Die dritte Schlüsselaktion (KA3) unterstützt Politikentwicklung und Zusammenarbeit. Die Jean-Monnet-Maßnahmen sind ein eigener Bereich — Förderung von Lehre und Forschung zur europäischen Integration.', bullets: ['KA3: Unterstützung für Politikreformen', 'Jean-Monnet-Module und -Lehrstühle', 'Kompetenzzentren', 'Sport als eigener Bereich'] },
      ],
      covered: [
    ...
    'eures': {
      formats: [
        { icon: '🔍', title: 'EURES-Portal', duration: 'Immer verfügbar', description: 'Online-Plattform mit fast 4 Millionen Stellenangeboten und 1 Million Lebensläufen. Abgleich von Stellen und Kandidaten.', bullets: ['Jobs in 31 Ländern suchen', 'Deinen Lebenslauf hochladen', 'Nach Land, Branche und Bildungsstand filtern', 'Kostenlos für alle'] },
        { icon: '👤', title: 'EURES-Berater', duration: 'Termin buchen', description: 'Persönliche Beratung von über 1.000 Fachberatern in 270 EURES-Organisationen.', bullets: ['Lebenslauf-Prüfung und -Verbesserung', 'Rechtsberatung zur sozialen Sicherheit', 'Informationen zu Lebens- und Arbeitsbedingungen', 'Kontakt über Portal, Telefon oder Chat'] },
      ],
      covered: [
        { icon: '🔍', title: 'Stellendatenbank', desc: 'fast 4 Millionen Stellenangebote und 1 Million Lebensläufe im EURES-Portal.' },
      ...
      steps: [
        ...
        { n: '02', title: 'Jobs suchen', desc: 'Durchsuche fast 4 Millionen Stellenangebote. Filtere nach Ort, Art und Bildungsanforderungen.' },
