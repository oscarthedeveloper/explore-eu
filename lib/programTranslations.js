  ...
  en: {
    'europeiska-solidaritetskaren': {
      ...
      formats: [
        ...
        { icon: '💡', title: 'Solidarity Projects', duration: '2–12 months', description: 'Create your own project in your home community together with at least 5 people (including yourself). You choose the topic — part-time.', bullets: ['€630 per month for the project', 'Apply directly without an organisation', 'You decide the focus', 'Coach support included'] },
      ],
      covered: [
    ...
    'erasmus-plus': {
      ...
      formats: [
        ...
        { icon: '🏛️', title: 'Policy support (KA3) & Jean Monnet', duration: 'Varies', description: 'The third Key Action (KA3) supports policy development and cooperation. Jean Monnet actions are a separate strand — support for teaching and research on European integration.', bullets: ['KA3: support for policy reform', 'Jean Monnet modules and chairs', 'Centres of Excellence', 'Sport as a separate strand'] },
      ],
      covered: [
    ...
    'eures': {
      ...
      hero: { heading: 'All of Europe — your job market', sub: 'EURES is the EU\'s employment services network in 31 countries. Free advice, CV review, legal guidance and a database of nearly 4 million vacancies. For those who want to work in another European country.' },
      what: { heading: 'More than a job board', body: 'EURES — European Employment Services — is a network of more than 1,000 advisers who help jobseekers and employers across Europe every day. The network covers the EU\'s 27 member states plus Iceland, Liechtenstein, Norway and Switzerland — 31 countries in total.\n\nSince 2021 EURES has been coordinated by the European Labour Authority (ELA). Services are free and available to all Europeans, regardless of qualification level or profession.' },
      formats: [
        { icon: '🔍', title: 'EURES portal', duration: 'Always available', description: 'Online platform with nearly 4 million vacancies and 1 million CVs. Job and candidate matching.', bullets: ['Search jobs in 31 countries', 'Upload your CV', 'Filter by country, sector and education', 'Free for everyone'] },
        { icon: '👤', title: 'EURES advisers', duration: 'Book an appointment', description: 'Personal advice from 1,000+ specialist advisers in 270 EURES organisations.', bullets: ['CV review and improvement', 'Legal advice on social security', 'Information on living and working conditions', 'Contact via portal, phone or chat'] },
      ],
      covered: [
        { icon: '🔍', title: 'Job database', desc: 'nearly 4 million vacancies and 1 million CVs on the EURES portal.' },
      ...
      steps: [
        ...
        { n: '02', title: 'Search for jobs', desc: 'Browse nearly 4 million vacancies. Filter by location, type and educational requirements.' },
    ...
    'eurodesk': {
      ...
      hero: { heading: 'Find all opportunities in one place', sub: 'Eurodesk is the European network that helps young people navigate all EU opportunities. 38 centres, 3,500+ local information providers and a database of 200+ programmes.' },
      what: { heading: 'Your guide to EU opportunities', body: 'Eurodesk was founded in Edinburgh in March 1990 as a small regional helpdesk with a simple idea: gather all relevant European information in one place and present it in a youth-friendly way. The initiative was an immediate success.\n\nToday Eurodesk is a European network with 38 national centres linked to more than 3,500 local information providers in 36 countries. The network is funded by Erasmus+ and organised as an international non-profit association (AISBL) under Belgian law, headquartered in Brussels.\n\nEurodesk manages the European Youth Portal and is responsible for its helpdesk — answering thousands of questions a year about travelling abroad with EU programmes.' },
      formats: [
    ...
    'europa-direkt': {
      ...
      categoryLabel: 'Information & support',
      hero: { heading: 'A direct line to the EU', sub: 'Europe Direct is the EU\'s open door for all citizens. Call for free, chat or visit one of the around 400 local centres — in your own EU language. For any question about the EU: legislation, rights, programmes and funding.' },
    ...
    'eu-youth-portal': {
      ...
      what: { heading: 'More than a website', body: 'The EU Youth Portal is jointly maintained by the European Commission and the Eurodesk network. It is available in all 24 official EU languages, and DiscoverEU content is additionally available in Icelandic, Macedonian, Norwegian, Serbian and Turkish.\n\nThe portal is deeply embedded in the EU Youth Strategy 2019–2027 — the framework for EU youth policy cooperation based on the Council resolution of 26 November 2018. The strategy focuses on three core words: Engage, Connect and Empower.' },
      formats: [
  ...
  es: {
    'europeiska-solidaritetskaren': {
      ...
      formats: [
        ...
        { icon: '💡', title: 'Proyectos de solidaridad', duration: '2–12 meses', description: 'Crea tu propio proyecto en tu comunidad junto con al menos 5 personas (incluido tú). Eliges el tema — a tiempo parcial.', bullets: ['630 € al mes para el proyecto', 'Solicitud directa sin organización', 'Tú decides el enfoque', 'Apoyo de un coach incluido'] },
      ],
      covered: [
    ...
    'eures': { name: 'EURES', tagline: 'La red europea de servicios de empleo — encuentra trabajo, prácticas o formación en otro país europeo.', categoryLabel: 'Empleo y carrera', hero: { heading: 'Toda Europa — tu mercado laboral', sub: 'EURES es la red de servicios de empleo de la UE en 31 países. Asesoramiento gratuito, revisión de currículum, orientación jurídica y una base de datos con casi 4 millones de vacantes.' }, what: { heading: 'Mucho más que un tablón de empleo', body: 'EURES — Servicios Europeos de Empleo — es una red de más de 1.000 asesores que ayudan a buscadores de empleo y empleadores en toda Europa. La red cubre los 27 estados miembros de la UE más Islandia, Liechtenstein, Noruega y Suiza — 31 países en total.' }, faq: [{ q: '¿Es EURES realmente gratuito?', a: 'Sí. La mayoría de los servicios son gratuitos tanto para los buscadores de empleo como para los empleadores.' }] },
  ...
  it: {
    'europeiska-solidaritetskaren': { name: 'Corpo Europeo di Solidarietà', tagline: 'Fai volontariato, porta avanti un progetto di solidarietà o partecipa ad azioni umanitarie — finanziato dall\'UE.', categoryLabel: 'Volontariato', hero: { heading: 'Fai qualcosa che conti davvero', sub: 'Il Corpo Europeo di Solidarietà ti permette di fare volontariato all\'estero, avviare il tuo progetto in città o partecipare ad azioni umanitarie — completamente finanziato dall\'UE. Nessuna esperienza richiesta.' }, what: { heading: 'L\'UE paga — tu cambi il mondo', body: "Il Corpo Europeo di Solidarietà (CES) è il programma dell'UE per i giovani che vogliono fare la differenza. Puoi fare volontariato in un altro paese europeo, avviare il tuo progetto di solidarietà in città o partecipare ad azioni umanitarie fuori dall'UE — tutto con il sostegno finanziario dell'UE.\n\nIl programma ha un budget di 1,01 miliardi di euro per il 2021–2027 e persegue due obiettivi principali: offrire ai giovani opportunità accessibili di attività di solidarietà e migliorarne le competenze e l'occupabilità." }, faq: [{ q: 'Devo parlare inglese?', a: 'Non necessariamente. Molti progetti richiedono un inglese di base, ma ci sono progetti anche in altre lingue. È incluso un corso di lingue gratuito.' }, { q: 'Posso scegliere in quale paese andare?', a: 'Sì! Ti candidi a progetti specifici e scegli tu stesso a quali paesi e organizzazioni candidarti.' }, { q: 'Devo pagare qualcosa?', a: 'No. Il programma CES è gratuito per i partecipanti. L\'UE copre alloggio, viaggi, vitto e indennità mensile.' }],
      ...
      formats: [
        ...
        { icon: '💡', title: 'Progetti di solidarietà', duration: '2–12 mesi', description: 'Crea il tuo progetto nella tua comunità insieme ad almeno 5 persone (incluso te). Scegli tu il tema — part-time.', bullets: ['630 € al mese per il progetto', 'Candidatura diretta senza organizzazione', 'Decidi tu il tema', 'Supporto di un coach incluso'] },
      ],
      covered: [
  ...
  de: {
    'europeiska-solidaritetskaren': { name: 'Europäisches Solidaritätskorps', tagline: 'Leiste Freiwilligendienst, führe ein Solidaritätsprojekt durch oder nimm an humanitären Maßnahmen teil — finanziert von der EU.', categoryLabel: 'Freiwilligendienst', hero: { heading: 'Tu etwas, das wirklich zählt', sub: 'Das Europäische Solidaritätskorps ermöglicht dir Freiwilligendienst im Ausland, die Umsetzung deines eigenen Projekts oder die Teilnahme an humanitären Maßnahmen — vollständig finanziert von der EU. Keine Erfahrung erforderlich.' }, what: { heading: 'Die EU zahlt — du veränderst die Welt', body: 'Das Europäische Solidaritätskorps (ESK) ist das EU-Programm für junge Menschen, die einen Unterschied machen wollen. Du kannst in einem anderen europäischen Land Freiwilligendienst leisten, ein eigenes Solidaritätsprojekt in deiner Heimatstadt starten oder an humanitären Maßnahmen außerhalb der EU teilnehmen — alles mit finanzieller Unterstützung der EU.\n\nDas Programm hat ein Gesamtbudget von 1,01 Milliarden Euro für den Zeitraum 2021–2027 und verfolgt zwei Hauptziele: jungen Menschen zugängliche Möglichkeiten für Solidaritätsaktivitäten zu bieten und ihre Kompetenzen und Beschäftigungsfähigkeit zu verbessern.' }, faq: [{ q: 'Muss ich Englisch können?', a: 'Nicht unbedingt. Viele Projekte erfordern Grundkenntnisse in Englisch, aber es gibt auch Projekte in anderen Sprachen. Außerdem ist ein kostenloser Sprachkurs inklusive.' }, { q: 'Kann ich wählen, in welches Land ich fahre?', a: 'Ja! Du bewirbst dich auf konkrete Projekte und wählst selbst, bei welchen Ländern und Organisationen du dich bewerben möchtest.' }, { q: 'Muss ich etwas bezahlen?', a: 'Nein. Das ESK-Programm ist für Teilnehmende kostenlos. Die EU übernimmt Unterkunft, Reisen, Verpflegung und Taschengeld.' }],
      ...
      formats: [
        ...
        { icon: '💡', title: 'Solidaritätsprojekte', duration: '2–12 Monate', description: 'Erstelle dein eigenes Projekt in deiner Heimatgemeinschaft mit mindestens 5 Personen (dich eingeschlossen). Teilzeit.', bullets: ['630 € pro Monat für das Projekt', 'Direktbewerbung ohne Organisation', 'Du bestimmst den Schwerpunkt', 'Coach-Unterstützung inklusive'] },
      ],
      covered: [
    ...
    'eures': { name: 'EURES', tagline: 'Das europäische Arbeitsvermittlungsnetzwerk — finde Arbeit, ein Praktikum oder eine Ausbildung in einem anderen europäischen Land.', categoryLabel: 'Jobs und Karriere', hero: { heading: 'Ganz Europa — dein Arbeitsmarkt', sub: 'EURES ist das Netzwerk der Arbeitsvermittlungsdienste der EU in 31 Ländern. Kostenlose Beratung, Lebenslaufprüfung, Rechtsberatung und eine Datenbank mit fast 4 Millionen Stellenangeboten.' }, what: { heading: 'Mehr als eine Jobbörse', body: 'EURES — Europäische Arbeitsvermittlungsdienste — ist ein Netzwerk aus über 1.000 Beratern, die täglich Jobsuchende und Arbeitgeber in ganz Europa unterstützen. Das Netzwerk umfasst die 27 EU-Mitgliedstaaten sowie Island, Liechtenstein, Norwegen und die Schweiz — insgesamt 31 Länder.' }, faq: [{ q: 'Ist EURES wirklich kostenlos?', a: 'Ja. Die meisten Dienste sind für Jobsuchende und Arbeitgeber kostenlos.' }] },
